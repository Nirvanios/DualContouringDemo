...
void HandleMouseWheel(const SDL_MouseWheelEvent &e, float &distance) { distance += -e.y * 10.f; }
...
int main(int argc, char **argv) {
  ...
  GLSLProgram program;
  if (!program.initialise() || !program.compileShader(ShaderType_Vertex, "shader.vert") ||
      !program.compileShader(ShaderType_Fragment, "shader.frag") || !program.link()) {
